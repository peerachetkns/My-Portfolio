    ...
    <div className="bg-zinc-800 min-h-screen font-sans text-zinc-200 selection:bg-[#00b4d8]/30 selection:text-white pb-20 overflow-hidden">
      ...
      <section className="pt-48 pb-20 px-6 max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-16">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-zinc-300 text-lg leading-relaxed max-w-xl font-light mx-auto md:mx-0">
            AI and Machine Learning Engineer with a solid foundation in Computer Engineering. Experienced in analyzing complex datasets and architecting predictive models to transform raw data into actionable, intelligent solutions.
          </motion.p>
      ...
      <section id="skills" className="py-24 px-6 max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-center text-zinc-400 mb-16 font-light tracking-wide">Comprehensive toolkit spanning programming languages, machine learning, data visualization, and enterprise application tools.</p>
        </motion.div>
        ...
        >
          {[
            ...
            },
            {
              ...
              skills: ['Classification', 'Regression', 'Clustering', 'Ensemble (RF, ET, GB)', 'Deep Learning (CNN, LSTM)', 'Cross-Validation', 'Bias/Variance', 'Key Metrics (Accuracy, Precision, F1, ROC-AUC)']
            },
            {
              title: "Data Analysis, CV & Libraries",
              icon: (
                <svg className="w-6 h-6 text-[#00b4d8]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
                </svg>
              ),
              skills: ['EDA', 'Data Cleaning', 'Feature Engineering', 'Transformation', 'Imbalanced Handling', 'Image Enhancement', 'Spatial/Frequency Filtering', 'Restoration', 'Color Processing', 'Pandas', 'NumPy', 'Matplotlib', 'Seaborn', 'Scikit-Learn', 'TensorFlow/Keras', 'Power BI']
            },
            {
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <div className="space-y-32">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row gap-12 items-start mb-12">
                ...
                <motion.div variants={fadeUp} className="w-full md:w-[45%] space-y-5 pt-2">
                  ...
                  <div className="flex flex-wrap gap-3 pt-2 pb-6">
                    {['Python', 'Scikit-Learn', 'SMOTE'].map(tag => (
              ...
              {/* Deep Dive Grid - รายละเอียดเจาะลึก 3 คอลัมน์ด้านล่าง */}
              <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-zinc-800/50 p-6 rounded-xl border border-white/5 hover:border-[#00b4d8]/30 transition-all">
                  ...
                  <p className="text-zinc-400 text-sm font-light leading-relaxed">
                    Engineered relevant features including applying trigonometric encoding (sin/cos) for wind directions. Handled missing data via median imputation and linear interpolation, and managed outliers effectively using predefined threshold capping.
                  </p>
                </div>
            ...
            >
              {/* ขยายความกว้างและสัดส่วนกล่องรูป พร้อมนำฟิลเตอร์ดำที่บังออก */}
      ...
      <motion.section 
        ...
        className="py-32 max-w-3xl mx-auto px-6 text-center relative"
      >
        ...
        <p className="text-zinc-400 mb-12 font-light leading-relaxed">
          I'm currently seeking opportunities as a Machine Learning Engineer. 
          Feel free to reach out if you're looking for a dedicated engineer to join your team.
        </p>
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-12 text-lg font-light">
